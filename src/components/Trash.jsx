...
const Trash = () => {
  ...
  return (
    <div>
      ...
      <div className="mt-10">
        {
          !data && <h1 className="text-2xl font-extrabold mt-7 ml-5 md:flex md:w-full md:justify-center md:mt-10">Deleted Notes</h1>
        }
